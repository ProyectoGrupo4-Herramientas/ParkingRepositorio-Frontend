...
export default function ParkingMapPage() {
  const { spots, occupancy, selectedId, selectedSpot, showDetailsModal, handleSelect, closeModal } =
    useParkingSelection();
    ...
    <MainLayout>
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        <div className="flex-1 min-w-0">
          <ParkingGrid spots={spots} selectedId={selectedId} onSelect={handleSelect} />
        </div>
