...
const Header = ({ dataToExport }) => {
  const handleExportPDF = () => {
    ...
    const tableColumn = ["FECHA", "ENTRADA", "SALIDA", "PLACA", "UNIDAD", "TIPO", "DURACION"];
    const tableRows = [];
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      <div>
        <h2 className="text-2xl font-bold text-slate-900 tracking-tight">Historial de Accesos</h2>
